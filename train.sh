...
python -u train_lseg.py --mysetup 1 --mytraintype 10  --batch_size 1 --exp_name project2_test9_recovered_loss_1_conv_vitl16_split \
--base_lr 0.001 --weight_decay 1e-4 --no-scaleinv --max_epochs 240 --widehead --accumulate_grad_batches 2 --backbone clip_vitl16_384